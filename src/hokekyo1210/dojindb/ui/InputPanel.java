...
public class InputPanel extends JPanel implements ActionListener, MouseListener{
	...
	private void initComponents() {
		...
		inputField.setBounds(1, 1, (int)Main.DIAMETER*162, (int)Main.DIAMETER*32);
		...
		addBtn.setBounds((int)Main.DIAMETER*162, 1, (int)Main.DIAMETER*24, (int)Main.DIAMETER*31);
		...
		subBtn.setBounds((int)Main.DIAMETER*189, (int)Main.DIAMETER*2, (int)Main.DIAMETER*30,(int)Main.DIAMETER*30);
